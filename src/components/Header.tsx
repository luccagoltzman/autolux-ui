    ...
    <header className="sticky top-0 z-50 w-full bg-black shadow-md">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <Link href="/" className="text-2xl font-bold text-red-600 flex items-center">
          <span className="ml-2">GARRA Auto Center</span>
        </Link>
        ...
        <nav className="hidden md:flex space-x-8">
          ...
          <Link href="/servicos" className="text-white hover:text-red-500 transition-colors">
            Serviços
          </Link>
          <Link href="/agendamento" className="text-white hover:text-red-500 transition-colors">
            Agendamento
          </Link>
        </nav>
